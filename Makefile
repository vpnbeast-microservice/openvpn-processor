...
compile:
	...
	# MacOS
	GOOS=darwin GOARCH=386 go build -o bin/main-darwin-386 cmd/main.go
	# Linux
	...
	# 64-Bit
	# FreeBDS
	GOOS=freebsd GOARCH=amd64 go build -o bin/main-freebsd-amd64 cmd/main.go
	# MacOS
